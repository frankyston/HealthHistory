...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { exam_date: @exam.exam_date, exam_location: @exam.exam_location, shared: @exam.shared, title: @exam.title, user_id: @exam.user_id } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { exam_date: @exam.exam_date, exam_location: @exam.exam_location, shared: @exam.shared, title: @exam.title, user_id: @exam.user_id } }
