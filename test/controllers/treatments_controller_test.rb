...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { files: @treatment.files, shared: @treatment.shared, treatment_date: @treatment.treatment_date, treatment_location: @treatment.treatment_location, user_id: @treatment.user_id } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { files: @treatment.files, shared: @treatment.shared, treatment_date: @treatment.treatment_date, treatment_location: @treatment.treatment_location, user_id: @treatment.user_id } }
