...
class ConsultationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultation" do
    assert_difference('Consultation.count') do
      post consultations_url, params: { consultation: { consultation_date: @consultation.consultation_date, name_of_professional: @consultation.name_of_professional, shared_with: @consultation.shared_with, title: @consultation.title, user_id: @consultation.user_id } }
    end
  ...
  test "should update consultation" do
    patch consultation_url(@consultation), params: { consultation: { consultation_date: @consultation.consultation_date, name_of_professional: @consultation.name_of_professional, shared_with: @consultation.shared_with, title: @consultation.title, user_id: @consultation.user_id } }
